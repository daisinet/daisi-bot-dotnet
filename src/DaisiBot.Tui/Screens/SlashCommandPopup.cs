...
public class SlashCommandPopup
{
    ...
    [
        ...
        new("status",   "Show status",          4),
        new("start",    "Start bot",            5),
        new("stop",     "Stop bot",             6),
        new("kill",     "Stop & delete bot",    7),
        new("runnow",   "Run bot now",          8),
        new("clear",    "Clear output",         9),
        new("model",    "Pick model",           10),
        new("settings", "Open settings",        11),
        new("skills",   "Browse skills",        12),
        new("export",   "Export data",          13),
        new("install",  "Install skill",        14, RequiresArgs: true),
        new("login",    "Login flow",           15),
    ];
