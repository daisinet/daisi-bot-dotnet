...
public class SlashCommandPopup
{
    ...
    [
        ...
        new("list",     "List bots",            3),
        new("status",   "Toggle status panel",  4),
        new("update",   "Edit bot settings",    5),
        new("start",    "Start bot",            6),
        new("stop",     "Stop bot",             7),
        new("kill",     "Stop & delete bot",    8),
        new("runnow",   "Run bot now",          9),
        new("clear",    "Clear output",         10),
        new("model",    "Pick model",           11),
        new("settings", "Open settings",        12),
        new("skills",   "Browse skills",        13),
        new("export",   "Export data",          14),
        new("install",  "Install skill",        15, RequiresArgs: true),
        new("login",    "Login flow",           16),
    ];
