...
public class SlashCommandPopup
{
    ...
    [
        ...
        new("kill",     "Stop a bot",           5),
        new("runnow",   "Run bot now",          6),
        new("clear",    "Clear output",         7),
        new("model",    "Pick model",           8),
        new("settings", "Open settings",        9),
        new("skills",   "Browse skills",        10),
        new("export",   "Export data",          11),
        new("install",  "Install skill",        12, RequiresArgs: true),
        new("login",    "Login flow",           13),
    ];
